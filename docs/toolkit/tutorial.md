...
The [reference bundle](../examples.md) shows the destination; this tutorial
walks the road. Starting from an empty directory you will author a
three-concept bundle, validate it, let the [proposer](proposer.md) upgrade
...
[Getting started](../getting-started.md)), run from the repository root so
...
carries the machine-readable layer. [How the heuristics work](proposer.md)
covers cue phrases, domains, confidence, and the limits.

## 5. Project to RDF

Load the bundle and serialize the graph — same two calls as the
[five-minute tour](index.md#a-five-minute-tour):
...
[Markdown to RDF](../guide/markdown-to-rdf.md).

## 6. Visualize it

The [Knowledge graph](../graph.md) page on this site is the pattern to copy:
