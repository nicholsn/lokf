...
[`lokf.rdf.serialize`](../reference/api.md): attach the generated context,
...
See [Markdown to RDF](../guide/markdown-to-rdf.md) for the mechanics of the
projection, and [Query](query.md) to run SPARQL over the result.
