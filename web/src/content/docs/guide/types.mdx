...
description: The classes a concept's type may name, each mapped to a public ontology term, plus the type-specific fields for each.
sidebar:
  order: 3
---

import { Tabs, TabItem } from "@astrojs/starlight/components";
import { Content as TypeTable } from "../../../generated/type-table.md";
...
:::note[Authoritative definitions]
